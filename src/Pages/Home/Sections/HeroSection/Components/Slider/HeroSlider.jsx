          ...
          <SwiperSlide className={styles["swiper-slide"]} position="relative">
            <Box component="div" className={styles.headerSliderText}>
              ...
              <p>
                ...
                <span>
                  $247<sup className={styles.secondSup}>.99</sup>
                </span>
              </p>
            ...
            <Box
              ...
              src="https://firebasestorage.googleapis.com/v0/b/shop-8b88e.appspot.com/o/b19ec7de-2a28-4eff-9e3b-564f9864058b.jpg?alt=media&token=49243794-c5d4-4da9-8a28-2bd8053460d2"
            />
          </SwiperSlide>
          <SwiperSlide className={styles["swiper-slide"]} position="relative">
            <Box component="div" className={styles.headerSliderText}>
              ...
              <p>
                ...
                <span>
                  $29
                  <sup className={styles.secondSup} style={{ top: "-0.2em" }}>
                    .99
                  </sup>
                </span>
              </p>
            ...
            <Box
              ...
              src="https://firebasestorage.googleapis.com/v0/b/shop-8b88e.appspot.com/o/27a789d0-6270-4fbf-aa6c-dd9d062070cd.jpg?alt=media&token=3dae993d-4ce1-4958-b5cb-490f44dc5601"
            />
          </SwiperSlide>
        </Swiper>
      </>
